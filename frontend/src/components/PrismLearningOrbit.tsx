    ...
    <div className={`prism-learning-orbit prism-learning-orbit--${state}`} data-static={isStatic ? "true" : "false"} data-testid="prism-learning-orbit">
      <svg className="prism-learning-orbit__svg" data-testid="prism-learning-orbit-svg" aria-hidden="true" viewBox="0 0 100 100" role="presentation">
        ...
        <g filter="url(#prism-orbit-glow)">
          <motion.ellipse data-testid="orbit-highlight" cx="50" cy="50" rx="39" ry="28" fill="none" stroke="#dff28a" strokeWidth="0.55" strokeLinecap="round" opacity={isSplit ? 0.88 : 0.62} style={{ transformOrigin: "50px 50px" }} initial={{ rotate: 28 }} animate={isStatic ? undefined : { opacity: [0.55, 0.82, 0.55], rotate: [28, 388] }} transition={{ opacity: { duration: 8, repeat: Infinity, ease: "easeInOut" }, rotate: { duration: 22, repeat: Infinity, ease: "linear" } }} />
